...
def plot_confirmed(test_pred):
    ...
    plt.savefig('../result/figure/India/10/vSIR/confirmed_delta_' + country + '.png')
...
if __name__ == '__main__':
    ...
    for ind in inds:
        ...
        tspan = np.linspace(len(tmp_t), len(tmp_t)+window_forward, 11)
    ...
    with open('../result/figure/India/10/vSIR/' + country + '_model_res.txt', 'a') as file:

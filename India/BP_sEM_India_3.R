...
test_num = c(30, 27, 24, 21, 18, 15, 12, 9, 6, 3)
estimate = vector(mode='list', 10)
for(i in 1:10){
...
for(i in 1:10){
  ...
  write.csv(area[[i]], paste0('./result/disease_pre/India/3/',region_name, '_', test_num[i], '.csv'), row.names = FALSE) 
}
